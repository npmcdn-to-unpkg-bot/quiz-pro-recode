...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(1); // commonJs方式引入
	var pic1 = __webpack_require__(2);
	var pic2 = __webpack_require__(3);
	var pic3 = __webpack_require__(4);
	...
	$.post('../../api/discover/get_quiz_user_result_list.json',{item_id:item_id,size:5},function(res){
		...
		//如果参加了测验，则初始化测验列表result
			...
			for(var i=0;i<resultList.length;i++){
				...
				if(is_pass){
					quizResult.push('<li class="item"  user_answer_string='+user_answer_string+' item_id="'+item_id+'"><div class="test-pic"><img src="'+pic3+'"/></div><div class="test-desc"><h1>考题</h1><p>'+commonObj.timeFormat(quiz_time)+'</p></div><div class="test-tongji"><span class="pass-question-count-pass">'+question_right_count+'</span><span class="total-question-count">/'+question_total_count+'</span></div></li>');	
				}else{
			...
			quizResult.push('</ul></div><a class="try-again">再去挑战一次</a>');
			...
			$(".item").on('click',commonObj.openQuizResult);
			$(".try-again").on('click',commonObj.quizAgain);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "1ec937efdc609e57391c8f371c060574.png";

/***/ },
/* 3 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "1cd792ccb73e75bd2e75815c3093bafe.png";

/***/ },
/* 4 */
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function Common(){
		var _this = this;
		this.choiceSelected = function(event){
			var parentNode = event.target.parentNode;
			var type = parentNode.getAttribute('type');
			if(type == 'OPTION_SINGLE' || type == 'TRUE_FALSE'){
				var liSelected = parentNode.parentNode.getElementsByTagName('li');
				...
				parentNode.firstChild.setAttribute('src','./img/single-round-selecting.png');
				parentNode.className = 'choice selected';	
				parentNode.parentNode.parentNode.parentNode.parentNode.className = 'question-basic is-answered';
			}else if(type == 'OPTION_MULTI'){
				if(parentNode.className == 'choice'){ // 选项未选中时
					parentNode.firstChild.setAttribute('src','./img/multi-rectangle-selecting.png');
					parentNode.className = 'choice selected';
					parentNode.parentNode.parentNode.parentNode.className = 'question-basic is-answered';
				}else if(parentNode.className == 'choice selected'){ // 选项选中时	
					// 测验题目所有已选择的选项
					var parentNodeChildNodes  = parentNode.parentNode.getElementsByClassName('selected');	
					parentNode.firstChild.setAttribute('src','./img/multi-rectangle-unselected.png');
					parentNode.className = 'choice';				
					//当所有已选择的选项为空时，修改测验题的状态为“未选择”
					if(parentNodeChildNodes.length == 0){
						parentNode.parentNode.parentNode.parentNode.className = 'question-basic no-answered';
					}
				}
			}
		 ...
		 * @return null 
		 */
		this.openQuizResult = function(event){
			...
			var user_answer_string = event.currentTarget.getAttribute('user_answer_string');
		...
		this.quizAgain = function(){
			...
			$(".choice").on('click',_this.choiceSelected,false);
			$("#question-wrap").show();
		...
		this.loadMore = function(loadUrl,data){
